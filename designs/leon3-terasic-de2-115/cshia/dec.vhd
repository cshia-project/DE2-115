...
-- The decoder for BCH code (127,64), t=10
...
ARCHITECTURE dpdbma OF dpdbm IS
	...
	SIGNAL m0in, m1in, m2in, m3in, m4in, m5in, m6in: BIT_VECTOR(0 TO m-1);
  BEGIN
	...
	aux(5)<= ddin(5) XOR ddin(6);
	m0in<= ddin(0) & ddin(1) & ddin(2) & ddin(3) & ddin(4) & ddin(5) & ddin(6);
	m1in<= ddin(1) & ddin(2) & ddin(3) & ddin(4) & ddin(5) & ddin(6) & aux(0);
	m2in<= ddin(2) & ddin(3) & ddin(4) & ddin(5) & ddin(6) & aux(0) & aux(1);
	m3in<= ddin(3) & ddin(4) & ddin(5) & ddin(6) & aux(0) & aux(1) & aux(2);
	m4in<= ddin(4) & ddin(5) & ddin(6) & aux(0) & aux(1) & aux(2) & aux(3);
	m5in<= ddin(5) & ddin(6) & aux(0) & aux(1) & aux(2) & aux(3) & aux(4);
	m6in<= ddin(6) & aux(0) & aux(1) & aux(2) & aux(3) & aux(4) & aux(5);
	m0:  dsdbm
...
ARCHITECTURE dpma OF dpm IS
	...
	SIGNAL b: BIT_VECTOR(0 TO 12);
	SIGNAL c0, c1, c2, c3, c4, c5, c6: BIT_VECTOR(0 TO m-1);
  BEGIN
	b(0 TO m-1)<= din1;
	b(7)<= b(0) XOR b(6);
	b(8)<= b(6) XOR b(5);
	...
	b(11)<= b(3) XOR b(2);
	b(12)<= b(2) XOR b(1);
	c0<= b(0) & b(6) & b(5) & b(4) & b(3) & b(2) & b(1);
	m0: dsdbm
		PORT MAP (din2, c0, dout(0));
	c1<= b(1) & b(7) & b(8) & b(9) & b(10) & b(11) & b(12);
	m1: dsdbm
		PORT MAP (din2, c1, dout(1));
	c2<= b(2) & b(1) & b(7) & b(8) & b(9) & b(10) & b(11);
	m2: dsdbm
		PORT MAP (din2, c2, dout(2));
	c3<= b(3) & b(2) & b(1) & b(7) & b(8) & b(9) & b(10);
	m3: dsdbm
		PORT MAP (din2, c3, dout(3));
	c4<= b(4) & b(3) & b(2) & b(1) & b(7) & b(8) & b(9);
	m4: dsdbm
		PORT MAP (din2, c4, dout(4));
	c5<= b(5) & b(4) & b(3) & b(2) & b(1) & b(7) & b(8);
	m5: dsdbm
		PORT MAP (din2, c5, dout(5));
	c6<= b(6) & b(5) & b(4) & b(3) & b(2) & b(1) & b(7);
	m6: dsdbm
...
USE CSHIA.bch.ALL;
ENTITY dxort IS
PORT (din0, din1, din2, din3, din4, din5, din6, din7, din8, din9, din10: IN BIT;
	dout: OUT BIT);
END dxort;

ARCHITECTURE dxorta OF dxort IS
  BEGIN
	dout<= din0 XOR din1 XOR din2 XOR din3 XOR din4 XOR din5 XOR din6 XOR din7 XOR din8 XOR din9 XOR din10;
END dxorta;
...
USE CSHIA.bch.ALL;
ENTITY dcheq IS
PORT (din1, din2, din3, din4, din5, din6, din7, din8, din9, din10: IN BIT_VECTOR(0 TO m-1); 
...
ARCHITECTURE dcheqa OF dcheq IS
  ...
  BEGIN
	eq(0)<= NOT din1(0) XOR din2(0) XOR din3(0) XOR din4(0) XOR din5(0) XOR din6(0) XOR din7(0) XOR din8(0) XOR din9(0) XOR din10(0);
	eq(1)<= din1(1) XOR din2(1) XOR din3(1) XOR din4(1) XOR din5(1) XOR din6(1) XOR din7(1) XOR din8(1) XOR din9(1) XOR din10(1);
	eq(2)<= din1(2) XOR din2(2) XOR din3(2) XOR din4(2) XOR din5(2) XOR din6(2) XOR din7(2) XOR din8(2) XOR din9(2) XOR din10(2);
	eq(3)<= din1(3) XOR din2(3) XOR din3(3) XOR din4(3) XOR din5(3) XOR din6(3) XOR din7(3) XOR din8(3) XOR din9(3) XOR din10(3);
	eq(4)<= din1(4) XOR din2(4) XOR din3(4) XOR din4(4) XOR din5(4) XOR din6(4) XOR din7(4) XOR din8(4) XOR din9(4) XOR din10(4);
	eq(5)<= din1(5) XOR din2(5) XOR din3(5) XOR din4(5) XOR din5(5) XOR din6(5) XOR din7(5) XOR din8(5) XOR din9(5) XOR din10(5);
	eq(6)<= din1(6) XOR din2(6) XOR din3(6) XOR din4(6) XOR din5(6) XOR din6(6) XOR din7(6) XOR din8(6) XOR din9(6) XOR din10(6);
	dout<= NOT (eq(0) OR eq(1) OR eq(2) OR eq(3) OR eq(4) OR eq(5) OR eq(6));
END dcheqa;
...
ARCHITECTURE dsyn1a OF dsyn1 IS
	SIGNAL syn: BIT_VECTOR(0 TO 14);
  BEGIN
	syn(7)<= syn(3) XOR syn(5); -- 7
	syn(8)<= syn(1) XOR syn(4); -- 4
	syn(9)<= syn(6) XOR syn(7); -- 4
	syn(10)<= syn(2) XOR syn(5); -- 3
	syn(11)<= syn(3) XOR syn(6); -- 2
	syn(12)<= syn(6) XOR syn(8); -- 2
	syn(13)<= syn(2) XOR syn(4); -- 1
	syn(14)<= syn(9) XOR syn(13); -- 1
		-- Saving due to optimization = 24
	...
	dout16(0)<= syn(0);
	dout16(1)<= syn(14);
	dout16(2)<= syn(1) XOR syn(2) XOR syn(7);
	dout16(3)<= syn(9);
	dout16(4)<= syn(2) XOR syn(3) XOR syn(8);
	dout16(5)<= syn(7);
	dout16(6)<= syn(5) XOR syn(6);
  PROCESS BEGIN
	WAIT UNTIL clk'EVENT AND clk='1';
	IF pe='1' THEN
	  syn(0)<= din;
...
ARCHITECTURE dsyn3a OF dsyn3 IS
  ...
  BEGIN
	syn(7)<= syn(2) XOR syn(6); -- 6
	syn(8)<= syn(3) XOR syn(4); -- 4
	syn(9)<= syn(1) XOR syn(5); -- 3
	syn(10)<= syn(4) XOR syn(7); -- 2
	syn(11)<= syn(7) XOR syn(9); -- 2
	syn(12)<= syn(8) XOR syn(11); -- 1
		-- Saving due to optimization = 18
	dout3(0)<= syn(0);
	dout3(1)<= syn(5);
	dout3(2)<= syn(3);
	dout3(3)<= syn(3) XOR syn(9);
	dout3(4)<= syn(6);
	dout3(5)<= syn(4);
	dout3(6)<= syn(10);
	dout6(0)<= syn(0);
	dout6(1)<= syn(6);
	dout6(2)<= syn(5) XOR syn(6);
	dout6(3)<= syn(4);
	dout6(4)<= syn(8);
	dout6(5)<= syn(10);
	dout6(6)<= syn(12);
	dout12(0)<= syn(0);
	dout12(1)<= syn(8);
	dout12(2)<= syn(6) XOR syn(8);
	dout12(3)<= syn(10);
	dout12(4)<= syn(2) XOR syn(4) XOR syn(5);
	dout12(5)<= syn(12);
	dout12(6)<= syn(3) XOR syn(11);
  PROCESS BEGIN
	WAIT UNTIL clk'EVENT AND clk='1';
	IF pe='1' THEN
	  syn(0)<= din;
...
ENTITY dsyn5 IS
PORT (clk, pe ,din: IN BIT;
	dout5, dout10: OUT BIT_VECTOR(0 TO m-1));
END dsyn5;

ARCHITECTURE dsyn5a OF dsyn5 IS
	SIGNAL syn: BIT_VECTOR(0 TO 12);
  BEGIN
	syn(7)<= syn(4) XOR syn(5); -- 4
	syn(8)<= syn(6) XOR syn(7); -- 3
	syn(9)<= syn(2) XOR syn(3); -- 2
	syn(10)<= syn(0) XOR syn(5); -- 1
	syn(11)<= syn(1) XOR syn(5); -- 1
	syn(12)<= syn(2) XOR syn(5); -- 1
		-- Saving due to optimization = 12
	dout5(0)<= syn(10);
	dout5(1)<= syn(3) XOR syn(7);
	dout5(2)<= syn(4) XOR syn(6);
	dout5(3)<= syn(9);
	dout5(4)<= syn(12);
	dout5(5)<= syn(11);
	dout5(6)<= syn(8);
	dout10(0)<= syn(10);
	dout10(1)<= syn(12);
	dout10(2)<= syn(4) XOR syn(9);
	dout10(3)<= syn(11);
	dout10(4)<= syn(1) XOR syn(8);
	dout10(5)<= syn(8);
	dout10(6)<= syn(8) XOR syn(9);
  PROCESS BEGIN
	WAIT UNTIL clk'EVENT AND clk='1';
	IF pe='1' THEN
	  syn(0)<= din;
	...
	ELSE
	  syn(0)<= syn(6) XOR din;
	  syn(1)<= syn(0) XOR syn(6);
	  syn(2)<= syn(1) XOR syn(6);
	  syn(3)<= syn(2) XOR syn(6);
	  syn(4)<= syn(3);
	  syn(5)<= syn(4);
	  syn(6)<= syn(5);
	END IF;
...
ARCHITECTURE dsyn7a OF dsyn7 IS
	SIGNAL syn: BIT_VECTOR(0 TO 13);
  BEGIN
	syn(7)<= syn(3) XOR syn(6); -- 6
	syn(8)<= syn(2) XOR syn(7); -- 3
	syn(9)<= syn(4) XOR syn(5); -- 3
	syn(10)<= syn(0) XOR syn(1); -- 1
	syn(11)<= syn(6) XOR syn(9); -- 1
	syn(12)<= syn(8) XOR syn(9); -- 1
	syn(13)<= syn(10) XOR syn(12); -- 1
		-- Saving due to optimization = 16
	dout7(0)<= syn(13);
	dout7(1)<= syn(1) XOR syn(3) XOR syn(5);
	dout7(2)<= syn(8);
	dout7(3)<= syn(3);
	dout7(4)<= syn(11);
	dout7(5)<= syn(5);
	...
	dout14(0)<= syn(13);
	dout14(1)<= syn(11);
	dout14(2)<= syn(1) XOR syn(4) XOR syn(7);
	dout14(3)<= syn(5);
	dout14(4)<= syn(5) XOR syn(8);
	dout14(5)<= syn(6);
	dout14(6)<= syn(7);
  PROCESS BEGIN
	WAIT UNTIL clk'EVENT AND clk='1';
...
ENTITY dsyn9 IS
PORT (clk, pe ,din: IN BIT;
	dout9, dout18, dout17: OUT BIT_VECTOR(0 TO m-1));
END dsyn9;

ARCHITECTURE dsyn9a OF dsyn9 IS
	SIGNAL syn: BIT_VECTOR(0 TO 14);
  BEGIN
	syn(7)<= syn(5) XOR syn(6); -- 8
	syn(8)<= syn(3) XOR syn(7); -- 5
	syn(9)<= syn(2) XOR syn(4); -- 3
	syn(10)<= syn(0) XOR syn(8); -- 2
	syn(11)<= syn(1) XOR syn(4); -- 1
	syn(12)<= syn(3) XOR syn(9); -- 1
	syn(13)<= syn(4) XOR syn(6); -- 1
	syn(14)<= syn(4) XOR syn(7); -- 1
		-- Saving due to optimization = 22
	dout9(0)<= syn(10);
	dout9(1)<= syn(4) XOR syn(5);
	dout9(2)<= syn(5) XOR syn(11);
	dout9(3)<= syn(1) XOR syn(3);
	dout9(4)<= syn(2);
	dout9(5)<= syn(14);
	dout9(6)<= syn(12);
	dout18(0)<= syn(10);
	dout18(1)<= syn(2);
	dout18(2)<= syn(5) XOR syn(9);
	dout18(3)<= syn(14);
	dout18(4)<= syn(1) XOR syn(6);
	dout18(5)<= syn(12);
	dout18(6)<= syn(1) XOR syn(9);
	dout17(0)<= syn(10);
	dout17(1)<= syn(13);
	dout17(2)<= syn(4) XOR syn(8);
	dout17(3)<= syn(1) XOR syn(2) XOR syn(7);
	dout17(4)<= syn(2) XOR syn(3);
	dout17(5)<= syn(8) XOR syn(11);
	dout17(6)<= syn(2) XOR syn(8);
  PROCESS BEGIN
	WAIT UNTIL clk'EVENT AND clk='1';
	IF pe='1' THEN
	  syn(0)<= din;
...
ARCHITECTURE dsyn11a OF dsyn11 IS
  ...
  PROCESS BEGIN
	...
	IF pe='1' THEN
	  ...
	  syn(1 TO 6)<= "000000";
	ELSE
	syn(0)<= din XOR syn(2) XOR syn(3);
	syn(1)<= syn(2) XOR syn(4);
	syn(2)<= syn(3) XOR syn(5);
	syn(3)<= syn(4) XOR syn(6);
	syn(4)<= syn(0) XOR syn(5);
	syn(5)<= syn(0) XOR syn(1) XOR syn(6);
	syn(6)<= syn(1) XOR syn(2);
	END IF;
  END PROCESS;
END dsyn11a;
...
ARCHITECTURE dsyn13a OF dsyn13 IS
  ...
  PROCESS BEGIN
	...
	IF pe='1' THEN
	  ...
	  syn(1 TO 6)<= "000000";
	ELSE
	syn(0)<= din XOR syn(0) XOR syn(1) XOR syn(6);
	syn(1)<= syn(0) XOR syn(2) XOR syn(6);
	syn(2)<= syn(1) XOR syn(3);
	syn(3)<= syn(2) XOR syn(4);
	syn(4)<= syn(3) XOR syn(5);
	syn(5)<= syn(4) XOR syn(6);
	syn(6)<= syn(0) XOR syn(5);
	END IF;
  END PROCESS;
END dsyn13a;
...
ARCHITECTURE dsyn15a OF dsyn15 IS
  ...
  PROCESS BEGIN
	...
	IF pe='1' THEN
	  ...
	  syn(1 TO 6)<= "000000";
	ELSE
	syn(0)<= din XOR syn(4) XOR syn(6);
	syn(1)<= syn(0) XOR syn(4) XOR syn(5) XOR syn(6);
	syn(2)<= syn(1) XOR syn(5) XOR syn(6);
	syn(3)<= syn(0) XOR syn(2) XOR syn(6);
	syn(4)<= syn(1) XOR syn(3);
	syn(5)<= syn(2) XOR syn(4);
	syn(6)<= syn(3) XOR syn(5);
	END IF;
  END PROCESS;
END dsyn15a;
...
ARCHITECTURE dsyn19a OF dsyn19 IS
  ...
  PROCESS BEGIN
	...
	IF pe='1' THEN
	  ...
	  syn(1 TO 6)<= "000000";
	ELSE
	syn(0)<= din XOR syn(0) XOR syn(2) XOR syn(6);
	syn(1)<= syn(0) XOR syn(1) XOR syn(2) XOR syn(3) XOR syn(6);
	syn(2)<= syn(1) XOR syn(2) XOR syn(3) XOR syn(4);
	syn(3)<= syn(2) XOR syn(3) XOR syn(4) XOR syn(5);
	syn(4)<= syn(3) XOR syn(4) XOR syn(5) XOR syn(6);
	syn(5)<= syn(0) XOR syn(4) XOR syn(5) XOR syn(6);
	syn(6)<= syn(1) XOR syn(5) XOR syn(6);
	END IF;
  END PROCESS;
END dsyn19a;
...
ARCHITECTURE dch4a OF dch4 IS
  ...
  BEGIN
	...
	chin(3)<= ch(5) XOR ch(6);
	chin(4)<= ch(0) XOR ch(6);
	chin(5)<= ch(1);
	chin(6)<= ch(2);
  PROCESS BEGIN
	WAIT UNTIL clk'EVENT AND clk='1';
...
ARCHITECTURE dch5a OF dch5 IS
  ...
  BEGIN
	...
	chin(2)<= ch(3) XOR ch(4);
	chin(3)<= ch(4) XOR ch(5);
	chin(4)<= ch(5) XOR ch(6);
	chin(5)<= ch(0) XOR ch(6);
	chin(6)<= ch(1);
  PROCESS BEGIN
	WAIT UNTIL clk'EVENT AND clk='1';
	IF pe='1' THEN
...
ARCHITECTURE dch6a OF dch6 IS
  ...
  BEGIN
	...
	chin(3)<= ch(3) XOR ch(4);
	chin(4)<= ch(4) XOR ch(5);
	chin(5)<= ch(5) XOR ch(6);
	chin(6)<= ch(0) XOR ch(6);
  PROCESS BEGIN
	WAIT UNTIL clk'EVENT AND clk='1';
	IF pe='1' THEN
	  ch(0 TO m-1)<= din;
...
ARCHITECTURE dch7a OF dch7 IS
  ...
  BEGIN
	dout<= ch(0 TO m-1);
	ch(7)<= ch(0) XOR ch(6); -- 1
		-- optimization saving = 1 XOR gates
	chin(0)<= ch(7);
	chin(1)<= ch(1) XOR ch(7);
	chin(2)<= ch(1) XOR ch(2);
	chin(3)<= ch(2) XOR ch(3);
	chin(4)<= ch(3) XOR ch(4);
	chin(5)<= ch(4) XOR ch(5);
	chin(6)<= ch(5) XOR ch(6);
  PROCESS BEGIN
	WAIT UNTIL clk'EVENT AND clk='1';
	IF pe='1' THEN
	  ch(0 TO m-1)<= din;
...
ARCHITECTURE dch8a OF dch8 IS
  ...
  BEGIN
	dout<= ch(0 TO m-1);
	chin(0)<= ch(5) XOR ch(6);
	chin(1)<= ch(0) XOR ch(5);
	chin(2)<= ch(0) XOR ch(1) XOR ch(6);
	chin(3)<= ch(1) XOR ch(2);
	chin(4)<= ch(2) XOR ch(3);
	chin(5)<= ch(3) XOR ch(4);
	chin(6)<= ch(4) XOR ch(5);
  PROCESS BEGIN
	WAIT UNTIL clk'EVENT AND clk='1';
	IF pe='1' THEN
	  ch(0 TO m-1)<= din;
...
ARCHITECTURE dch9a OF dch9 IS
  ...
  BEGIN
	dout<= ch(0 TO m-1);
	chin(0)<= ch(4) XOR ch(5);
	chin(1)<= ch(4) XOR ch(6);
	chin(2)<= ch(0) XOR ch(5);
	chin(3)<= ch(0) XOR ch(1) XOR ch(6);
	chin(4)<= ch(1) XOR ch(2);
	chin(5)<= ch(2) XOR ch(3);
	chin(6)<= ch(3) XOR ch(4);
  PROCESS BEGIN
	WAIT UNTIL clk'EVENT AND clk='1';
	IF pe='1' THEN
	  ch(0 TO m-1)<= din;
...
ARCHITECTURE dch10a OF dch10 IS
  ...
  BEGIN
	dout<= ch(0 TO m-1);
	chin(0)<= ch(3) XOR ch(4);
	chin(1)<= ch(3) XOR ch(5);
	chin(2)<= ch(4) XOR ch(6);
	chin(3)<= ch(0) XOR ch(5);
	chin(4)<= ch(0) XOR ch(1) XOR ch(6);
	chin(5)<= ch(1) XOR ch(2);
	chin(6)<= ch(2) XOR ch(3);
  PROCESS BEGIN
	WAIT UNTIL clk'EVENT AND clk='1';
	IF pe='1' THEN
	  ch(0 TO m-1)<= din;
...
ARCHITECTURE dcaa OF dca IS
  ...
  BEGIN
	...
	cLast<= NOT ca(0) AND NOT ca(1) AND NOT ca(2) AND ca(3);  -- ca= 8
...
ARCHITECTURE dcounta OF dcount IS
  ...
  BEGIN
	...
	clastb<= NOT cb(0) AND cb(1) AND cb(2) AND cb(3);  -- cb= 14
	clasta<= NOT ca(0) AND NOT ca(1) AND NOT ca(2) AND NOT ca(3);  -- ca= 0
	clast<= clasta AND clastb; -- count= 126
	chpe1b<= cb(0) AND NOT cb(1) AND NOT cb(2) AND cb(3);  -- cb= 9
	chpe1a<= ca(0) AND ca(1) AND ca(2) AND NOT ca(3);  -- ca= 7
	chpe1<= chpe1a AND chpe1b; -- count= 88
	vdout1Rb<= NOT cb(0) AND cb(1) AND NOT cb(2) AND NOT cb(3);  -- cb= 2
	vdout1Ra<= NOT ca(0) AND NOT ca(1) AND NOT ca(2) AND ca(3);  -- ca= 8
	vdout1R<= vdout1Ra AND vdout1Rb; -- count= 26
	vdout1Sb<= cb(0) AND NOT cb(1) AND NOT cb(2) AND cb(3);  -- cb= 9
	vdout1Sa<= NOT ca(0) AND NOT ca(1) AND NOT ca(2) AND ca(3);  -- ca= 8
	vdout1S<= vdout1Sa AND vdout1Sb; -- count= 89
	bufRb<= cb(0) AND cb(1) AND cb(2) AND NOT cb(3);  -- cb= 7
	bufRa<= NOT ca(0) AND NOT ca(1) AND NOT ca(2) AND NOT ca(3);  -- ca= 0
	bufR<= bufRa AND bufRb; -- count= 63
	cb0<= NOT cb(0) AND NOT cb(1) AND NOT cb(2) AND NOT cb(3);  -- cb= 0
	lCe<= caLast AND NOT cb0;
	caLast1<= caLast;
	cceR<= NOT ca(0) AND ca(1) AND ca(2) AND NOT ca(3);  -- ca= 6
...
ARCHITECTURE deca OF dec IS
	...
	COMPONENT dxort                       -- (t-1) * XOR
		PORT (din0, din1, din2, din3, din4, din5, din6, din7, din8, din9, din10: IN BIT; dout: OUT BIT);
		END COMPONENT;
	...
	SIGNAL syn1, syn2, syn3, syn4, syn5, syn6, syn7, syn8, syn9, syn10, syn11, syn12, syn13, syn14, syn15, syn16, syn17, syn18, syn19: BIT_VECTOR(0 TO m-1);
	SIGNAL sn0out, sn1out, sn2out, sn3out, sn4out, sn5out, sn6out, sn7out, sn8out, sn9out, sn10out, sn11out, sn12out, sn13out, sn14out, sn15out, sn16out, sn17out, sn18out: BIT_VECTOR(0 TO m-1);
	SIGNAL sn0in, sn1in, sn2in, sn3in, sn4in, sn5in, sn6in, sn7in, sn8in, sn9in, sn10in, sn11in, sn12in, sn13in, sn14in, sn15in, sn16in, sn17in, sn18in: BIT_VECTOR(0 TO m-1);
	SIGNAL c1out, c2out, c3out, c4out, c5out, c6out, c7out, c8out, c9out, c10out: BIT_VECTOR(0 TO m-1);
	SIGNAL b3out, b4out, b5out, b6out, b7out, b8out, b9out, b10out: BIT_VECTOR(0 TO m-1);
	SIGNAL ch1out, ch2out, ch3out, ch4out, ch5out, ch6out, ch7out, ch8out, ch9out, ch10out: BIT_VECTOR(0 TO m-1);

	-- for different option by C program
	SIGNAL b4set, b4sIn: BIT;
	SIGNAL sn0en, sn1en, sn2en, sn3en, sn4en, sn5en, sn6en, sn7en, sn8en, sn9en, sn10en: BIT_VECTOR(0 TO m-1);
	SIGNAL cc2out, cc3out, cc4out, cc5out, cc6out, cc7out, cc8out: BIT_VECTOR(0 TO m-1);
	SIGNAL b5in, b6in, b7in, b8in, b9in, b10in: BIT_VECTOR(0 TO m-1);
  ...
  BEGIN
	...
	ms0: dxort
		PORT MAP (sn0en(0), sn1en(0), sn2en(0), sn3en(0), sn4en(0), sn5en(0), sn6en(0), sn7en(0), sn8en(0), sn9en(0), sn10en(0), cs(0));
	ms1: dxort
		PORT MAP (sn0en(1), sn1en(1), sn2en(1), sn3en(1), sn4en(1), sn5en(1), sn6en(1), sn7en(1), sn8en(1), sn9en(1), sn10en(1), cs(1));
	ms2: dxort
		PORT MAP (sn0en(2), sn1en(2), sn2en(2), sn3en(2), sn4en(2), sn5en(2), sn6en(2), sn7en(2), sn8en(2), sn9en(2), sn10en(2), cs(2));
	ms3: dxort
		PORT MAP (sn0en(3), sn1en(3), sn2en(3), sn3en(3), sn4en(3), sn5en(3), sn6en(3), sn7en(3), sn8en(3), sn9en(3), sn10en(3), cs(3));
	ms4: dxort
		PORT MAP (sn0en(4), sn1en(4), sn2en(4), sn3en(4), sn4en(4), sn5en(4), sn6en(4), sn7en(4), sn8en(4), sn9en(4), sn10en(4), cs(4));
	ms5: dxort
		PORT MAP (sn0en(5), sn1en(5), sn2en(5), sn3en(5), sn4en(5), sn5en(5), sn6en(5), sn7en(5), sn8en(5), sn9en(5), sn10en(5), cs(5));
	ms6: dxort
		PORT MAP (sn0en(6), sn1en(6), sn2en(6), sn3en(6), sn4en(6), sn5en(6), sn6en(6), sn7en(6), sn8en(6), sn9en(6), sn10en(6), cs(6));
	c2: dshr
	...
	s5: dsyn5
		PORT MAP (clk, synpe, din,  syn5, syn10);
	s7: dsyn7
		PORT MAP (clk, synpe, din,  syn7, syn14);
	s9: dsyn9
		PORT MAP (clk, synpe, din,  syn9, syn18, syn17);
	s11: dsyn11
	...
	x0: dmul21
		PORT MAP (synpe, sn17out, syn3, sn0in);
	x1: dmul21
		PORT MAP (synpe, sn18out, syn2, sn1in);
	x2: dmul21
		PORT MAP (synpe, sn0out, syn1, sn2in);
	x3: dmul21
		PORT MAP (synpe, sn1out, syn19, sn3in);
	x4: dmul21
		PORT MAP (synpe, sn2out, syn18, sn4in);
	x5: dmul21
		PORT MAP (synpe, sn3out, syn17, sn5in);
	x6: dmul21
		PORT MAP (synpe, sn4out, syn16, sn6in);
	x7: dmul21
		PORT MAP (synpe, sn5out, syn15, sn7in);
	x8: dmul21
		PORT MAP (synpe, sn6out, syn14, sn8in);
	x9: dmul21
		PORT MAP (synpe, sn7out, syn13, sn9in);
	x10: dmul21
		PORT MAP (synpe, sn8out, syn12, sn10in);
	x11: dmul21
		PORT MAP (synpe, sn9out, syn11, sn11in);
	x12: dmul21
		PORT MAP (synpe, sn10out, syn10, sn12in);
	x13: dmul21
		PORT MAP (synpe, sn11out, syn9, sn13in);
	x14: dmul21
		PORT MAP (synpe, sn12out, syn8, sn14in);
	x15: dmul21
		PORT MAP (synpe, sn13out, syn7, sn15in);
	x16: dmul21
		PORT MAP (synpe, sn14out, syn6, sn16in);
	x17: dmul21
		PORT MAP (synpe, sn15out, syn5, sn17in);
	x18: dmul21
		PORT MAP (synpe, sn16out, syn4, sn18in);
	sn0: drdce
	...
	cheg: dcheq
		PORT MAP (ch1out, ch2out, ch3out, ch4out, ch5out, ch6out, ch7out, ch8out, ch9out, ch10out,  err);
